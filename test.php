<html>
   <head>
      ...
      <?php
         //Kêt nối CSDL
$con =mysqli_connect("localhost","root","", "giangday");
         ...
         // Hàm lấy dữ liệu từ CSDL và hiển thị
             function getData()
             {
                ...
                mysqli_set_charset($con,"utf8");
                 ...
                 $giatri = "";
                 $query = "SELECT giangvien.tengiangvien, monhoc.tenmonhoc,giangvien_monhoc.* FROM Giangvien_Monhoc INNER JOIN giangvien ON giangvien_monhoc.magiangvien=giangvien.magiangvien INNER JOIN monhoc ON giangvien_monhoc.mamonhoc=monhoc.mamonhoc";
